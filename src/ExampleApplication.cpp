...
void ExampleApplication::CreateImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling,
...
VkImageView ExampleApplication::CreateImageView(VkImage image, VkFormat format) {
