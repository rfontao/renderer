...
// Shadow map ctor
VulkanTexture::VulkanTexture(std::shared_ptr<VulkanDevice> device, int texWidth, int texHeight) : m_Device(device) {

    m_Image = make_shared<VulkanImage>(m_Device, texWidth, texHeight, 1, VK_SAMPLE_COUNT_1_BIT,
                                       VK_FORMAT_D16_UNORM,
                                       VK_IMAGE_TILING_OPTIMAL,
